...
int main()
{
    ...
    //string name = "../pruebas_parcial2/imagenes/colp.png";
...
void reduccionc(QImage im,char color){
...
vector<int> reduccionf(QImage im, vector<int> promred)
{
...
void aumentoc(QImage im, char color){
...
void escribir(vector<int> datos)
{
...
void igualc(QImage im,char color)
{
...
vector<int> rotar(vector<int> mod_data)
{
